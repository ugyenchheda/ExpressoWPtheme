		...
		if (!empty($location)):
			...
			?><section class="left location"><?php
				...
				foreach($location as $type => $text){
					echo '<div class="col-md-6 col-sm-12 col-xs-12" style="text-align: center;"><i class="fa fa-'.$type.'"></i>&nbsp;&nbsp;'.$text.'</div>';
				}
...
<header id="header" class="def" style="height:<?php echo $header_height.'px'; ?>;">
	<div class="shell" style="height:<?php echo $header_height.'px'; ?>;">
		...
		if (!empty($location)):
			...
			?><section class="left location" style="height:<?php echo $header_height.'px'; ?>;">
					<div class="col-md-12"><span><i class="fa fa-home"></i>&nbsp;&nbsp; 4 0 0  Myrth&nbsp;  Ave&nbsp;  Essex,&nbsp;  MD&nbsp;  21221</span></div>
					<div class="col-md-12"><span><i class="fa fa-phone"></i>&nbsp;&nbsp;  (410) 686-9747</span></div>
